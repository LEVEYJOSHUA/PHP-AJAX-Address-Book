...
//Run Query
$db->query("INSERT INTO `contacts` (first_name, last_name, email, phone, address1, address2, city, region, postcode, contact_group, notes)
								VALUES (:first_name, :last_name, :email, :phone, :address1, :address2, :city, :region, :postcode, :contact_group, :notes)");
