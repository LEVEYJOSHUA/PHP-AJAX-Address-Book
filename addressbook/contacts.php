				...
				<tbody>
					...
					<tr>
						...
						<ul>
							...
							<li><?php echo $contact->city; ?>, <?php echo $contact->region; ?> <?php echo $contact->postcode; ?></li>
						</ul>
						</td>
						...
						<form id="editContact" action="#" method="post">
						  ...
						  <div class="row">
							...
							<div class="large-4 columns">
								<label>Postcode
								<input name="postcode" type="text" placeholder="Enter Postcode" value="<?php echo $contact->postcode; ?>" />
							  </label>
							</div>
						  </div>
						  <div class="row">
